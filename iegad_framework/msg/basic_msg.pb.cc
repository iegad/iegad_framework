...
void protobuf_AddDesc_basic_5fmsg_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\017basic_msg.proto\022\tiegad.net\"B\n\tbasic_ms"
...
basic_msg::basic_msg()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:iegad.net.basic_msg)
}
...
basic_msg::basic_msg(const basic_msg& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:iegad.net.basic_msg)
}
...
basic_msg::~basic_msg() {
  // @@protoc_insertion_point(destructor:iegad.net.basic_msg)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:iegad.net.basic_msg)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:iegad.net.basic_msg)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:iegad.net.basic_msg)
  return false;
#undef DO_
}
...
void basic_msg::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:iegad.net.basic_msg)
  // required int32 msg_type = 1;
  if (has_msg_type()) {
  ...
  // @@protoc_insertion_point(serialize_end:iegad.net.basic_msg)
}

::google::protobuf::uint8* basic_msg::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:iegad.net.basic_msg)
  // required int32 msg_type = 1;
  if (has_msg_type()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:iegad.net.basic_msg)
  return target;
}
