...
iegad::net::basic_proxy::~basic_proxy()
{
    if (clnt_.is_open()) {
	clnt_.close();
    }
...
int iegad::net::basic_proxy::_send_msg(int msg_type, int msg_flag, const std::string & msg_bdstr)
...
int iegad::net::basic_proxy::_recv_msg(basic_msg & msgbsc, boost::system::error_code & err_code)
...
int iegad::net::basic_proxy::_connect()
